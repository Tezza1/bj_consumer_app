                ...
                <div className="row">
                    <div className="col">
                        <ul className="pagination">
                            ...
                            <li className="page-item"><a className="page-link" data-toggle="collapse" data-target=".principleCollapse1">2</a></li>
                            <li className="page-item"><a className="page-link" data-toggle="collapse" data-target="#principle3">3</a></li>
                            <li className="page-item"><a className="page-link" data-toggle="collapse" data-target="#principle4">4</a></li>
                            <li className="page-item"><a className="page-link" data-toggle="collapse" data-target="#principle5">5</a></li>
                            <li className="page-item"><a className="page-link" data-toggle="collapse" data-target="#principle2">Next</a></li>
                        </ul>
                    </div>
                    <div className="col">
